...
# Zeitreihe für einen Tag in 1-Minuten-Intervallen erstellen
times = pd.date_range(start=date, end=date + pd.Timedelta(days=1), freq='1min', tz=tz)
...
weather_df = weather_df.set_index('time').tz_convert(tz)
